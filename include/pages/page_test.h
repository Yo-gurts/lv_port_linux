...
#define PAGE_TEST_KEY_COUNT 6
#define PAGE_TEST_MAX_TRACE_DOTS 512
...
typedef struct {
    ...
    page_test_key_item_t key_items[PAGE_TEST_KEY_COUNT];

    lv_obj_t* trace_dots[PAGE_TEST_MAX_TRACE_DOTS];
