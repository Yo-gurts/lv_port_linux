...
typedef struct {
    const char *name;
    void (*create)(page_manager_t *pm, void *user_data);
    void (*destroy)(page_manager_t *pm, void *user_data);
    void (*show)(page_manager_t *pm, void *user_data);
    void (*hide)(page_manager_t *pm, void *user_data);
    void (*update)(page_manager_t *pm, void *user_data);
} page_interface_t;
